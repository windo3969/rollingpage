// 가는 선 아이콘 (docs/design/DESIGN.md). 색은 currentColor를 따른다.
...
export const ShuffleIcon = (p: IconProps) => (
  <Icon {...p}>
    ...
    <path d="M2 18h1.4c1.3 0 2.5-.6 3.3-1.7l6.1-8.6c.7-1.1 2-1.7 3.3-1.7H22M2 6h1.9c1.5 0 2.9.9 3.6 2.2M22 18h-5.9c-1.3 0-2.6-.7-3.3-1.8l-.5-.8" />
  </Icon>
);
